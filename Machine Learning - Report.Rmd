...
setwd("C:/Users/Raj/Documents/Machine Learning")
```

##Loading and preprocessing the data
Two csv files containing the training and test data was downloaded from Amazon's cloudfront into a data folder in the working directory.
...
The model produced a very small OOB error rate of 0.69%. This was deemed satisfactory enough to progress the testing.
...
This model yielded a 99.4% prediction accuracy. Again, this model proved very robust and adequete to predict new data.
